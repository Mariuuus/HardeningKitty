Function Invoke-HardeningKitty {
    ...
    If ($Report.IsPresent) {
        $Message = '"ID","Name","Severity","Result","DefaultValue","Recommended"'
        ...
        ForEach ($Finding in $FindingList) {
            ...
            If ($Finding.Method -eq 'Registry') {
                ...
                If (Test-Path -Path $Finding.RegistryPath) {
                    ...
                    try {
                        ...
                        $Result = "Used DefaultValue: " + $Finding.DefaultValue
                    }
                } Else {
                    $Result = "Used DefaultValue: " + $Finding.DefaultValue
                }
            ...
            If ($Mode -eq "Audit") {
                ...
                If ($ResultPassed) {
                    ...
                    If ($Report) {
                        $Message = '"'+$Finding.ID+'","'+$Finding.Name+'","Passed","'+$Result+'","'+$Finding.DefaultValue+'","'+$Finding.RecommendedValue+'"'
                        Add-MessageToFile -Text $Message -File $ReportFile
                    }
                    ...
                    If ($Report) {
                        $Message = '"'+$Finding.ID+'","'+$Finding.Name+'","'+$Finding.Severity+'","'+$Result+'","'+$Finding.DefaultValue+'","'+$Finding.RecommendedValue+'"'
                        Add-MessageToFile -Text $Message -File $ReportFile
                    }
